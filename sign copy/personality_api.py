...
async def read_index():
    index_path = os.path.join(STATIC_DIR, "personality_test.html")
    if not os.path.exists(index_path): raise HTTPException(404, "personality_test.html dosyası 'static' klasöründe bulunamadı.")
    return index_path
